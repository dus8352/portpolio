...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('<%=application.getContextPath() %>/resources/img/result.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>경기 결과</h1>
            <button id="result-btn">경기 결과 보기</button>
            <button id="read-btn">리뷰 보기</button>
