...
<script>
 $(function(){
	 $("#delete1-btn").click(function(e){
		 e.preventDefault();
		 location.href="<%=application.getContextPath()%>/"
	 });
 });
 $(function(){
	 $("#update1-btn").click(function(e){
		 e.preventDefault();
		 location.href="<%=application.getContextPath()%>/Member/Update"
	 });
 });
</script>
</head>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>마이페이지</h1>
            <button id="update1-btn">회원정보 수정</button>
	<button id="delete1-btn">회원탈퇴</button>
